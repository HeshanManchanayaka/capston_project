...
function Home() {
  ...
  <div className="side-section right-section" data-aos="fade-down">
    ...
    <p>Mindfulness reduces stress, enhances focus, improves emotional regulation, boosts mental clarity, and promotes overall well-being and resilience.<br/><br/><br/><br/>
    Continue your mindfulness.....</p>
  </div>
</div>
